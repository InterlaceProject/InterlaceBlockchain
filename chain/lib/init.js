...
async function initBlockchain(transfer) {
  ...
  let m1 = factory.newResource(NS, 'Individual', 'm1');
  m1.firstName='f1';
  m1.surName='s1';
  m1.employedBy='ab';
  ...
  let m2 = factory.newResource(NS, 'Individual', 'm2');
  m2.firstName='f2';
  m2.surName='s2';
  m2.employedBy='ab';
  ...
  let a1 = factory.newResource(NS, 'CCAccount', 'a1');
  a1.creditLimit=0;
  ...
  let a2 = factory.newResource(NS, 'CCAccount', 'a2');
  a2.creditLimit=0;
