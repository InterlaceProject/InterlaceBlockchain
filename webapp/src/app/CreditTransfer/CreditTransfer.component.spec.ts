...
import { CreditTransferComponent } from './CreditTransfer.component';
...
describe('CreditTransferComponent', () => {
  ...
  let mockCreditTransferService;
  let mockDataService

  beforeEach(async(() => {

    mockCreditTransferService = sinon.createStubInstance(CreditTransferService);
    mockCreditTransferService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreditTransferService, useValue: mockCreditTransferService },
